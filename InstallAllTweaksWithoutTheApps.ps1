...
$scripts = @(
    ...
    @{ Name = ".\WindowsTweaksAdvanced\Hibernation.ps1"; Description = "Enabling Ultimate Performance, Turn on hibernation and stop sleep mode"; Parameter = ""; SleepTime = 2; MessageAfter = "" }
    @{ Name = ".\WindowsTweaksAdvanced\LegacyF8BootRecovery.ps1"; Description = "Enables Advanced Boot Options screen that lets you start Windows in advanced troubleshooting modes"; Parameter = ""; SleepTime = 0; MessageAfter = "" }
    @{ Name = ".\WindowsTweaksAdvanced\MSCopilot.ps1"; Description = "Remove MSCopilot,and turn off Recall"; Parameter = ""; SleepTime = 0; MessageAfter = "You may need to restart for some setting to change" }
    @{ Name = ".\WindowsTweaksAdvanced\RemoveMSStoreApps.ps1"; Description = "Remove Microsoft Store Apps"; Parameter = ""; SleepTime = 0; MessageAfter = "" }
    @{ Name = ".\WindowsTweaksAdvanced\TimeZoneLanguages.ps1"; Description = "Setting date, date format, timezone and location"; Parameter = ""; SleepTime = 2; MessageAfter = "" }
)
